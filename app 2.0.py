...
st.markdown("""
    <style>
        ...
        /* 鼠标悬停时的颜色 (稍微变深一点，增加交互感) */
        div.stButton > button:hover {
            background-color: #7451B0 !important;
            border-color: #7451B0 !important;
            color: white !important;
        }

        /* 鼠标点击时的颜色 */
        div.stButton > button:active {
            background-color: #61409C !important;
            border-color: #61409C !important;
            color: white !important;
        }
...
st.caption("© 2025 ZHAO Xinyi, HE Jingjing, ZHAO Zhenran. All Rights Reserved.")
